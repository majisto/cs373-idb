...
class MTG_TEST(TestCase) :
    ...
    def test_magic_card_id_2(self):
        ...
        self.assertEqual(r_dict["card_setID"].__str__(), 'BNG')
        self.assertEqual(r_dict["card_type"].__str__(), 'Enchant Creature')
        self.assertEqual(r_dict["card_subtype"].__str__(), 'Beast')
