...
class MagicCard(models.Model):
    ...
    def get_absolute_url(self):
        return "http://ni42.pythonanywhere.com/cards/id="+str(self.card_ID)
...
class MagicSet(models.Model):
    ...
    set_release_date = models.CharField('date released', max_length = 255) # yyyy/mm/dd
    set_num_cards = models.IntegerField()
    set_story = models.TextField()
    set_details = models.TextField()
    ...
    def get_absolute_url(self):
        return "http://ni42.pythonanywhere.com/sets/" + self.set_ID
...
class MagicType(models.Model):
    ...
    def _subtype_list (self):
        result = ""
        for subtype in self.type_subtypes.all() :
            result + subtype.subtype_name + " "
        return result

    type_subtype_list = property(_subtype_list)
    ...
    def get_absolute_url(self):
        return "http://ni42.pythonanywhere.com/types/" + self.type_name
